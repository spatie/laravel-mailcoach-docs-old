...
![](https://mailcoach.app/images/docs/v1/app/campaigns/campaign-statistics-overview.png)
...
A bounce means that an email could not be delivered to a certain email address, this could happen for several reasons. You can better find out why in the [_Outbox_](/docs/v1/app/campaigns/campaign-statistics#outbox) tab.

## Opens and clicks

![](https://mailcoach.app/images/docs/v1/app/campaigns/campaign-statistics-opens.png)

In the _Opens_ tab, you can see which subscribers have already opened your email, and when.

![](https://mailcoach.app/images/docs/v1/app/campaigns/campaign-statistics-clicks.png)
...
![](https://mailcoach.app/images/docs/v1/app/campaigns/campaign-statistics-unsubscribes.png)

You can also see how many people, regrettably, clicked the unsubscribe link in this campaign.

## Outbox

![](https://mailcoach.app/images/docs/v1/app/campaigns/campaign-statistics-outbox.png)
