...
1. If you already have a Laravel 7 application, you can install Mailcoach as a package inside it. Head over to the [package installation instructions](/docs/v2/package/general/installation-and-setup) to continue.
