...
![](https://mailcoach.app/images/docs/v3/mailgun-domain-settings.png)
...
![](https://mailcoach.app/images/docs/v3/app/mail-configuration/mailgun-copy-webhook.png)
...
![](https://mailcoach.app/images/docs/v3/mailgun-webhooks.png)
...
![](https://mailcoach.app/images/docs/v3/app/mail-configuration/mailgun-copy-webhook-signing-key.png)
...
![](https://mailcoach.app/images/docs/v3/app/mail-configuration/mailgun-api-key.png)

Go to your _Mail configuration_ page in Mailcoach, and fill in the fields:

![](https://mailcoach.app/images/docs/v3/app/mail-configuration/mailgun-setup-mail-config.png)
