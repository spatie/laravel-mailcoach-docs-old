...
This event will be fired as soon as someone subscribes. If [double opt-in](/docs/v1/package/working-with-lists/using-double-opt-in) is enabled on the email list someone is in the process of subscribing to, this event will be fired when the subscription is confirmed.
...
This event will be fired when somebody clicks a link in a mail. This event will only be fired for campaigns that have [click tracking](/docs/v1/package/working-with-campaigns/tracking-clicks) enabled.
...
After a campaign has been sent, statistics will [be calculated according to a schedule](/docs/v1/package/working-with-campaigns/viewing-statistics-of-a-sent-campaign).
