...
Mailcoach can be installed as a package inside an existing Laravel application. This version of mailcoach does not come with any user management, instead your can [use a gate check to determine who can access Mailcoach](https://mailcoach.app/docs/v1/package/using-the-ui/authorizing-users).

In order to install Mailcoach you'll need to [get a license](/docs/v1/app/general/getting-a-license) first.
...
- [Amazon SES](/docs/v1/package/handling-feedback/amazon-ses)
- [Mailgun](/docs/v1/package/handling-feedback/mailgun)
- [Sendgrid](/docs/v1/package/handling-feedback/sendgrid)
...
This package handles various tasks in a queued way via [Laravel Horizon](https://laravel.com/docs/v1/master/horizon). If your application doesn't have Horizon installed yet, follow [their installation instructions](https://laravel.com/docs/v1/master/horizon#installation).
...
By default you can only use the Mailcoach on a local environment. To use it in other environment you need to register an gate check. Head over to [the section on authorizing users](/docs/v1/package/using-the-ui/authorizing-users) to learn more.
