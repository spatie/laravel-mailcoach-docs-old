...
In the sent mail [the placeholders](https://docs.spatie.be/laravel-mailcoach/v1/working-with-campaigns/creating-a-campaign/#setting-the-content-and-using-placeholders) won't be replaced. Rest assured that when you send the mail to your entire list, they will be replaced.
