...
- `::webviewUrl`: this string will be replaced with the URL that will display the content of your campaign. Learn more about this in [the docs on webviews](https://docs.spatie.be/laravel-email-campaigns/v1/advanced-usage/displaying-webviews/).
