...
The [scheduled](https://docs.spatie.be/laravel-mailcoach/v1/installation-setup/#schedule-the-calculate-statistics-command) 'email-campaigns:calculate-statistics' will fill these attributes on the `Campaign` model:
