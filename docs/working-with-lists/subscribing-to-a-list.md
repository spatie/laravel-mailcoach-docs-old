...
You can read more on extra attributes in [this section of the docs](https://docs.spatie.be/laravel-mailcoach/v1/advanced-usage/working-with-extra-attributes-on-subscribers/).
